"""
Random Policy Baseline Inference: CelebA dataset + AttGAN model
================================================================
...
output_file = "random_celeba_attgan_inference.txt"
print(f"[Random Baseline] CelebA / AttGAN  ->  {output_file}")
...
with open(output_file, "w", encoding="utf-8") as f:
    process = subprocess.Popen(
        [
            ...
            "--result_dir", "result_random_celeba_attgan",
            "--test_iters", "200000",
...
print(f"[Random Baseline] CelebA / AttGAN done. Output: {output_file}")
