"""
Greedy Policy Baseline Inference: MAADFace dataset + StarGAN model
===================================================================
...
output_file = "greedy_maadface_stargan_inference.txt"
print(f"[Greedy Baseline] MAADFace / StarGAN  ->  {output_file}")
...
with open(output_file, "w", encoding="utf-8") as f:
    process = subprocess.Popen(
        [
            ...
            "--result_dir", "result_greedy_maadface_stargan",
            "--test_iters", "200000",
...
print(f"[Greedy Baseline] MAADFace / StarGAN done. Output: {output_file}")
