...
from DiffusionCLIP.diffusionclip import DiffusionCLIP
from DiffusionCLIP.configs.paths_config import HYBRID_MODEL_PATHS
...
def parse_args_and_config():
    ...
    if args.edit_images_from_dataset:
        if args.model_path:
